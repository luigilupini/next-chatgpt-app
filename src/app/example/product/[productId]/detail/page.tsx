  ...
  return (
    <main className="center size-full">
      <Card className="p-5 flex flex-col gap-6">
        <h1 className="font-black italic text-xl">Product Detail</h1>
        ...
        <div className="between gap-2">
          <Button asChild className="px-2  w-full" variant={"outline"}>
            <Link href="/example/product">back product route</Link>
          </Button>
          <Button asChild className="px-2  w-full" variant={"outline"}>
            <Link href="/example/setting/profile/theme/security">
